...
def write_eda_report(metrics: dict[str, float], analysis: dict[str, pd.DataFrame], figure_paths: dict[str, Path]) -> None:
    ...
    lines = [
        ...
        "analysis uses the listings dataset price field.",
        "",
        "## Key Summary Metrics",
        "",
        "| Metric | Value |",
        ...
        *[
        ...
        "## Recommendations",
        "",
        "- Use `listings_clean.price` for all Day 2 pricing views.",
        "- Use `calendar_clean` for availability analysis only.",
        "- Segment future analysis by room type, neighbourhood, and host segment before drawing pricing conclusions.",
        "- Keep the calendar price limitation visible in any presentation or interview discussion.",
        "",
